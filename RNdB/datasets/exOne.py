...
class ExOne(Dataset):
    ...
    def get_dataset(self):
        ...
        self.df = pd.read_csv(os.path.join(data_location, "ex1.csv"))
        self.domain = json.load(open(os.path.join(data_location, "ex1-domain.json")))
